      ...
      <div className="bg-[#03373D] px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-white text-lg font-semibold">{parcel.title}</h2>
              <p className="text-[#CAEB66] text-sm">Tracking: {parcel.trackingNumber}</p>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              <p><FaUser className="inline mr-2 text-blue-600" /><strong>Name:</strong> {parcel.senderName}</p>
              <p><FaPhone className="inline mr-2 text-blue-600" /><strong>Contact:</strong> {parcel.senderContact}</p>
              <p><FaMapMarkerAlt className="inline mr-2 text-blue-600" /><strong>Location:</strong> {parcel.senderRegion} - {parcel.senderServiceCenter}</p>
              <p><FaHome className="inline mr-2 text-blue-600" /><strong>Address:</strong> {parcel.senderAddress}</p>
            </div>
          </div>
          ...
          <div className="bg-green-50 p-4 rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              <p><FaUser className="inline mr-2 text-green-600" /><strong>Name:</strong> {parcel.receiverName}</p>
              <p><FaPhone className="inline mr-2 text-green-600" /><strong>Contact:</strong> {parcel.receiverContact}</p>
              <p><FaMapMarkerAlt className="inline mr-2 text-green-600" /><strong>Location:</strong> {parcel.receiverRegion} - {parcel.receiverServiceCenter}</p>
              <p><FaHome className="inline mr-2 text-green-600" /><strong>Address:</strong> {parcel.receiverAddress}</p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6 px-2 md:px-0">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 mt-2">Track your parcels in real-time</p>
      </div>
        ...
        <form onSubmit={handleTrackingSearch} className="mb-4">
          <div className="flex gap-3">
            ...
            <button
              ...
              className="bg-[#03373D] text-white px-6 py-3 rounded-lg hover:bg-[#044a52] focus:outline-none focus:ring-2 focus:ring-[#CAEB66] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              {isSearching ? (
